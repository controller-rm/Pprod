...
# CONFIG / CSS
# =========================================================
st.set_page_config(page_title="Login Pprod", page_icon="🔐", layout="wide")
...
def login_page() -> None:
    ...
    with col2:
        ...
        with st.container(border=True):
            st.subheader("Acesso ao Painel Pprod")
...
# =========================================================
def header_bar():
    c1, c2, c3,c4 = st.columns([8, 5, 2, 2], vertical_alignment="center")
    ...
    #         key="btn_atualizar_pprod"
    #     ):
    #         forcar_refresh_completo()
    #         st.rerun()
...
Aguarde enquanto executamos o <b>Painel Pprod</b>.
</div>
